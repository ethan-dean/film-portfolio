    ...
    <div className="about">
      <div className="about-container">
        <div className="about-text-container">
          ...
          <p className="about-text-body">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat quo possimus eaque, aspernatur asperiores accusamus doloribus odio dicta numquam. Quas inventore dignissimos dolore a nihil quo dolor voluptatibus animi velit.Fugiat quo possimus eaque, aspernatur asperiores accusamus doloribus odio dicta numquam.</p>
          <p className="about-text-body">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat quo possimus eaque, aspernatur asperiores accusamus doloribus odio dicta numquam. Quas inventore dignissimos dolore a nihil quo dolor voluptatibus animi velit.Fugiat quo possimus eaque, aspernatur asperiores accusamus doloribus odio dicta numquam.</p>
        </div>
